...
# Aufruf:   docker build --tag juergenzimmermann/prisma:2026.4.1-hardened .
#               ggf. --progress=plain
#               ggf. --no-cache
#
...
#
#           docker debug juergenzimmermann/prisma:2026.4.1-hardened
#           docker network ls
#           docker save juergenzimmermann/prisma:2026.4.1-hardened > prisma.tar
...
LABEL org.opencontainers.image.title="prisma" \
  org.opencontainers.image.description="Appserver Prisma mit 'hardened' Basis-Image Bun und Debian 13" \
